...
Itogiidataset - папка в 2 "чистыми" данными (без шумов и выбросов), с которыми работаем над исследованием и приложением

flask - папка с файлами для корректной работы пользовательского приложения, включая само приложение

Materials - папка с некоторыми материалами в pdf по базальтопластику и композитным материалам

Trebovania_k_VKR_MGTU_DS.docx - файл с требованиями к оформлению работы и всеми задачами

Shortanova R.I part1.ipynb - начало кода

Shortanova R.I part2.ipynb - завершение кода

Shortanova R.I part1.html - первая часть кода в html

Shortanova R.I part2.html - вторая часть кода в html

Презентация1.pdf - презентация ВКР  в формате pdf для защиты

Презентация1.pptx - презентация ВКР для защиты в формате pptx

Пояснительная записка Шортанова Р.И.docx - описание работы в формате docx
...
г)     •	В новом открывшемся окне (сайте) ввести 12 входных параметров и нажать "Отправить".

д)     •	в специальном разделе появится результат в виде числа с плавающей точкой. 


Автор: Шортанова Регина Исфандияровна 
...
#UPD. В работе есть неточности. Где-то описки, где-то опечатки. Замечаю и исправляю их со временем.
